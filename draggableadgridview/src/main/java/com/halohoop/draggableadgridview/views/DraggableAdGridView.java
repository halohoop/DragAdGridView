...
//        crossLineColor = mContext.getResources().getColor(android.R.color.darker_gray);
    ...
    public DraggableAdGridView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs,
                com.halohoop.draggableadgridview.R.styleable.DraggableAdGridViewAdBar);
        mAdbarHeight = attributes.getDimension(com.halohoop.draggableadgridview.R.styleable.DraggableAdGridViewAdBar_adbar_height, 100);
        mTmpAdbarHeight = mAdbarHeight;
        mAdBarRawPostion = attributes.getInteger(com.halohoop.draggableadgridview.R.styleable.DraggableAdGridViewAdBar_adbar_rawposition, 3);
        ...
        crossLineColor = attributes.getColor(com.halohoop.draggableadgridview.R.styleable.DraggableAdGridViewAdBar_crossline_color,
                context.getResources().getColor(android.R.color.darker_gray));
        mDragViewBgColor = attributes.getColor(com.halohoop.draggableadgridview.R.styleable.DraggableAdGridViewAdBar_drag_view_bg_color,
                DEFAULT_DRAGVIEW_BGCOLOR);
        mDragViewBgAlpha = attributes.getFloat(com.halohoop.draggableadgridview.R.styleable.DraggableAdGridViewAdBar_drag_view_bg_alpha, 1.0f);
        //初始化设置
        //initialize
